...
document.addEventListener('DOMContentLoaded', () => {
    const hospitalData = {
      ...
      "procedure": [
          ...
          { "step": "2", "title": "내원 및 수술 준비", "content": "📝 수술 동의서 작성<br>예약 시간에 맞춰 내원하여 수술 및 마취 과정에 대한 설명을 들으신 후 동의서를 작성합니다.<br><br>💧 수액 처치 및 안정화<br>아이는 바로 수술에 들어가지 않아요! 수액을 맞으며 몸의 수분과 전해질 균형을 맞추고, 산소방에서 편안하게 산소를 공급받으며 최상의 컨디션으로 수술을 준비합니다." },
          { "step": "3", "title": "안전 마취 및 치과 검사", "content": "😴 안전한 호흡마취<br>아이의 상태에 맞는 마취 프로토콜을 적용하여 안전하게 마취를 유도하고, 가장 안정적인 호흡마취로 전환합니다. 수술 내내 최신 모니터링 장비로 모든 활력 징후를 1:1로 집중 감시합니다.<br><br>📸 전체 치과 방사선 검사<br>눈으로 보이지 않는 치아 뿌리, 잇몸뼈(치조골)의 숨겨진 질병까지 정확히 진단하기 위해 모든 치아에 대한 방사선 촬영을 진행합니다." },
          { "step": "4", "title": "정밀 구강 검사 및 치료", "content": "🔎 치주 탐침 검사 (프로빙)<br>방사선 사진을 바탕으로 치아 하나하나의 치주낭 깊이, 출혈, 흔들림 등을 정밀하게 검사하여 치료 계획을 최종 확정합니다.<br><br>🦷 맞춤형 치과 치료<br>스케일링과 폴리싱을 기본으로, 검사 결과에 따라 발치, 신경치료, 잇몸치료 등 보호자님과 상의된 맞춤 치료를 진행합니다." },
          { "step": "5", "title": "회복 및 퇴원", "content": "💖 세심한 회복 케어<br>모든 치료가 끝나면, 전담 스텝이 아이가 완전히 의식을 회복하고 안정될 때까지 곁에서 세심하게 돌봅니다.<br><br>🏡 귀가 및 홈케어 안내<br>아이가 충분히 회복되면 보호자님께 연락을 드립니다. 퇴원 시 수술 후 주의사항과 홈케어 방법을 자세히 안내해 드립니다." },
          { "step": "6", "title": "수술 후 검진 (리체크)", "content": "👩‍⚕️ 예후 확인<br>발치나 잇몸 수술을 한 경우, 보통 1~2주 뒤에 내원하여 수술 부위가 잘 아물고 있는지 확인하는 검진(리체크)을 받게 됩니다. 건강한 구강 상태를 오래 유지하기 위한 마지막 단계입니다." }
      ],
      "healthCheck": {
        ...
        "costsSmall": {
          ...
          "items": [
              { "borderColor": "#f06292", "title": "🪄 통증 관리", "prices": [
                  { "label": "⏰ 마취시간 연장 (1시간 이내)", "value": "90,000 ~ 110,000원" },
...
function initCalculator(data) {
    ...
    const procedureList = {
        '발치': { cat: '발치/제거', items: [
            ...
            // --- START: 이미지 기반 업데이트 ---
            {l:'흡수-치관절제술-뿌리1', s:44000, lrg:55000, r:[1]},
            {l:'흡수-치근제거-뿌리1',   s:88000, lrg:110000, r:[1]},
            {l:'흡수-치관절제술-뿌리2', s:44000, lrg:55000, r:[2]},
            {l:'흡수-치근제거-뿌리2',   s:140000, lrg:180000, r:[2]},
            {l:'흡수-치관절제술-뿌리3', s:44000, lrg:55000, r:[3]},
            {l:'흡수-치근제거-뿌리3',   s:260000, lrg:360000, r:[3]}
            // --- END: 이미지 기반 업데이트 ---
        ]},
